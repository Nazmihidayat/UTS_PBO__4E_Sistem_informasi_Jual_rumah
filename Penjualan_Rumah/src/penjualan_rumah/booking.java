...
public class booking {
    ...
    public booking(int id_booking, int id_konsumen, int id_admin, String tgl_booking, String status, String tgl_verifikasi) {
    ...
    public void setTanggalBooking(String tgl_booking) {
        this.tgl_booking = tgl_booking;
    }
    ...
    public void setTanggalVerifikasi(String tgl_verifikasi) {
        this.tgl_verifikasi = tgl_verifikasi;
    }
     public static void main(String[] args) {
        // Membuat objek booking
        booking booking1 = new booking(1, 1, 1, new String(), "Booked", null);
        booking booking2 = new booking(2, 2, 2, new String(), "Verified", new String());
